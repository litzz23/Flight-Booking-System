  ...
  return (
    <div className="ac-wrap">
      <div className="ac-legend">
        {swapPreviewMode ? (
          <>
            <span><i className="ac-dot ac-dot-male" />Male</span>
            <span><i className="ac-dot ac-dot-female" />Female</span>
            <span><i className="ac-dot ac-dot-swap-requester" />Their offered seat</span>
            <span><i className="ac-dot ac-dot-swap-target" />Your seat</span>
          </>
        ) : (
          <>
            <span><i className="ac-dot ac-dot-available" />Available</span>
            <span><i className="ac-dot ac-dot-booked" />Booked</span>
            <span><i className="ac-dot ac-dot-male" />Male</span>
            <span><i className="ac-dot ac-dot-female" />Female</span>
            <span><i className="ac-dot ac-dot-selected" />Selected</span>
            {peerSwapMode && (
              <span><i className="ac-dot ac-dot-mine" />Your seat</span>
            )}
          </>
        )}
      </div>
      ...
      <div className="ac-cabin-shell">
        ...
        <div className="ac-columns">
          <span className="ac-col-group">
            {leftCols.map((col) => <span key={`left-${col}`}>{col}</span>)}
          </span>
          <span className="ac-aisle-label">Aisle</span>
          <span className="ac-col-group">
            {rightCols.map((col) => <span key={`right-${col}`}>{col}</span>)}
          </span>
        </div>
          ...
          {sortedRows.map((rowNumber, idx) => {
            ...
            return (
              <Row
                key={rowNumber}
                rowNumber={rowNumber}
                leftSeats={leftCols.map((col) => seatRows.get(rowNumber)[col] || null)}
                rightSeats={rightCols.map((col) => seatRows.get(rowNumber)[col] || null)}
                ...
                onPeerSwapSeatClick={peerSwapMode ? onPeerSwapSeatClick : noopPeer}
              />
            )
          })}
        </div>
